    ...
    faqs: [
      {
        ...
        answer:
          'A Will, also known as a "Last Will and Testament," is a legal document that outlines how your assets will be distributed after you pass away. A Last Will and Testament allows you to: specify who will inherit your assets, including personal belongings, real property, and finances; name an executor to manage your estate assets; and appoint guardians for minor children.',
      },
      {
        id: "5",
        question: "How does a Will work in California?",
        answer:
          'In California, when a person passes away with a Will, their estate typically goes through a legal process through the court known as "probate." This court process ensures that debts are paid, assets are distributed correctly, and legal formalities are met. Because probate can be a lengthy and costly process, many individuals choose to create a Living Trust instead of relying solely on a Will. However, a Will is still a crucial estate planning tool for those who want to ensure their wishes are documented legally.',
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "The estate planning process includes: (1) First Meeting to discuss your assets and goals, (2) Complete an Estate Plan Questionnaire, (3) Drafts are sent for review and approval, (4) Sign the Estate Plan, and (5) Estate Plan Maintenance and review at your request.",
      },
      {
        id: "12",
        question: "How long does it take to create an estate plan?",
        answer:
          "The timeline varies depending on the complexity of your estate and how quickly you can provide the necessary information. Typically, the process takes 2-4 weeks from the initial consultation to signing your documents. However, I work at your pace to ensure you're comfortable with every decision.",
      },
      {
        id: "15",
        question: "Can I update my estate plan after it's created?",
        answer:
          "Yes, absolutely. Life changes, and your estate plan should reflect those changes. While you are alive, you maintain full control over your Trust and property. You can add and/or remove property, change the beneficiaries, and change the Successor Trustees. I offer estate plan maintenance and review services at your request. I recommend reviewing your estate plan every few years or after major life events.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        answer:
          "For your first consultation, it's helpful to bring a list of your assets (real estate, bank accounts, investments, etc.), information about your beneficiaries, and any questions or concerns you have. However, don't worry if you don't have everything ready—we can work together to gather the necessary information during the estate planning process.",
      },
      {
        id: "14",
        question: "How much does estate planning cost?",
        answer:
          "Estate planning costs vary depending on the complexity of your needs and the documents required. During our initial consultation, I'll provide you with a clear quote based on your specific situation. I believe in transparent pricing with no hidden fees.",
      },
    ],
  },
]
